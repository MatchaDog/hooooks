...
var useIntersection = function useIntersection(ele) {
  var observedRef = react_1.useRef();

  var _react_1$useState = react_1.useState(false),
      _react_1$useState2 = _slicedToArray(_react_1$useState, 2),
      changeState = _react_1$useState2[0],
      setChangeState = _react_1$useState2[1];
  ...
  return [changeState, observedRef || undefined];
};
